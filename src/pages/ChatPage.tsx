...
export default function ChatPage() {
  ...
  const { sendMessage, isStreaming, streamingMessage, streamError } =
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const ok = await sendMessage(
      content || "📎 " + (attachmentData?.name || "attachment"),
      messages,
      conversation?.system_prompt,
      attachmentData,
      selectedModel
            ...
            <div className="max-w-3xl mx-auto relative">
              ...
              <form onSubmit={handleSubmit} className="relative">
                ...
                <textarea
                  ...
                  onPaste={handlePaste}
                  placeholder={
                    canChat ? t.chat.placeholder : t.pricing.limitReached
                  }
                  rows={1}
                  disabled={!canChat}
